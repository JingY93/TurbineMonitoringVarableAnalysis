...
{
    partial class SettingForElecLine
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SettingForElecLine));
            ...
            this.label2.Text = "对于海缆特定位置和时刻的数据判异，采用十字交叉判\r\n异法，既考虑同一位置不同时刻数据的横向比较，也考\r\n虑同一时刻不同位置的纵向比较";
            // 
            // textBox1
            // 
